    ...
    <Grid container>
      <Grid item xs={5}>
        <FormControl className={classes.formControl}>
          ...
          >
            <option value="" />
            <option value="projectName">{t('entities.project.projectName')}</option>
            <option value="subscriptionVersion">{t('entities.project.subscriptionVersion')}</option>
            <option value="subscriptionStartDate">
              {t('entities.project.subscriptionStartDate')}
            </option>
            <option value="subscriptionEndDate">{t('entities.project.subscriptionEndDate')}</option>
